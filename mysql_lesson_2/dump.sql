...
CREATE TABLE `friend_request` (
  ...
  KEY `fk_friend_request_user2_idx` (`to_user_id`) /*!80000 INVISIBLE */,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `like` (
  `type` enum('post','media','message') NOT NULL DEFAULT 'post',
  `user_id` int unsigned NOT NULL,
  `media_id` int unsigned NOT NULL,
  `post_id` int unsigned NOT NULL,
  `message_id` int unsigned NOT NULL,
  PRIMARY KEY (`user_id`,`media_id`,`message_id`,`post_id`),
...
-- Dump completed on 2021-03-13 20:48:17
